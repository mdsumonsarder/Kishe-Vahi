...
public class AtomActivity extends AppCompatActivity {
    ...
    int[] summImg={R.drawable.apple_img,R.drawable.blackberry,R.drawable.patakopi,
            R.drawable.gajor,R.drawable.mula,
            R.drawable.fulkopi,R.drawable.onion,
            R.drawable.pumkin,R.drawable.chili,R.drawable.salgom};
    String[] sumName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sumName=getResources().getStringArray(R.array.autum_item);
        ...
        summerList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent=new Intent(AtomActivity.this,ItemDetails2Activity.class);
                if(position==0)
                {
