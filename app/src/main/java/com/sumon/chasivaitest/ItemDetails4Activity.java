...
public class ItemDetails4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_item_details4);
        ...
        if(bundle!=null)
        {
            ...
            if(str.matches("0"))
            {
                dfr= FirebaseDatabase.getInstance().getReference("winter").child("1");
            ...
            {
                dfr= FirebaseDatabase.getInstance().getReference("winter").child("2");
                dfr.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        String str1=dataSnapshot.child("descr1").getValue().toString();
            ...
            {
                dfr= FirebaseDatabase.getInstance().getReference("winter").child("3");
                dfr.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        String str1=dataSnapshot.child("descr1").getValue().toString();
            ...
            {
                dfr= FirebaseDatabase.getInstance().getReference("winter").child("4");
                dfr.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        String str1=dataSnapshot.child("descr1").getValue().toString();
            ...
            {
                dfr= FirebaseDatabase.getInstance().getReference("winter").child("5");
                dfr.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        String str1=dataSnapshot.child("descr1").getValue().toString();
            ...
            {
                dfr= FirebaseDatabase.getInstance().getReference("winter").child("6");
                dfr.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        String str1=dataSnapshot.child("descr1").getValue().toString();
            ...
            {
                dfr= FirebaseDatabase.getInstance().getReference("winter").child("7");
                dfr.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        String str1=dataSnapshot.child("descr1").getValue().toString();
            ...
            {
                dfr= FirebaseDatabase.getInstance().getReference("winter").child("8");
                dfr.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        String str1=dataSnapshot.child("descr1").getValue().toString();
