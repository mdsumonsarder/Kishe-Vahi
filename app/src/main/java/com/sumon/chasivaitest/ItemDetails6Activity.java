...
public class ItemDetails6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_item_details6);
        ...
        if(bundle!=null)
        {
            String str=(String)bundle.get("data");
                ...
                dfr= FirebaseDatabase.getInstance().getReference("cow").child("1");
