...
public class ItemDetails3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(bundle!=null)
        {
            ...
            if(str.matches("0"))
            {
                dfr= FirebaseDatabase.getInstance().getReference("lateautumn").child("1");
            ...
            {
                dfr= FirebaseDatabase.getInstance().getReference("lateautumn").child("2");
                dfr.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        String str1=dataSnapshot.child("descr1").getValue().toString();
            ...
            {
                dfr= FirebaseDatabase.getInstance().getReference("lateautumn").child("3");
                dfr.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        String str1=dataSnapshot.child("descr1").getValue().toString();
            ...
            {
                dfr= FirebaseDatabase.getInstance().getReference("lateautumn").child("4");
                dfr.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        String str1=dataSnapshot.child("descr1").getValue().toString();
            ...
            {
                dfr= FirebaseDatabase.getInstance().getReference("lateautumn").child("5");
                dfr.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        String str1=dataSnapshot.child("descr1").getValue().toString();
            ...
            {
                dfr= FirebaseDatabase.getInstance().getReference("lateautumn").child("6");
                dfr.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        String str1=dataSnapshot.child("descr1").getValue().toString();
            ...
            {
                dfr= FirebaseDatabase.getInstance().getReference("lateautumn").child("7");
                dfr.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        String str1=dataSnapshot.child("descr1").getValue().toString();
            ...
            {
                dfr= FirebaseDatabase.getInstance().getReference("lateautumn").child("8");
                dfr.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        String str1=dataSnapshot.child("descr1").getValue().toString();
