...
public class SpringActivity extends AppCompatActivity {
    ...
    int[] summImg={R.drawable.brusselsprous,R.drawable.gajor,
            R.drawable.fulkopi,R.drawable.mula,R.drawable.patakopi,R.drawable.onion,
            R.drawable.broccoli,R.drawable.alu};
    String[] sumName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        summerList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent=new Intent(SpringActivity.this,ItemDetails5Activity.class);
                if(position==0)
                {
